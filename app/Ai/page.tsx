...
export default function page() {
  return (
    <div className="container mx-auto w-full max-w-[60rem] px-4 sm:px-6 md:px-10 lg:px-20 xl:px-32 py-6 md:py-12 border-2 border-[var(--light-gray)]">
      <div className="pt-52">
        <h1 className="font-bold text-xl md:text-3xl">DocuMint.ai</h1>
        <p className="md:text-xl text-[var(--darkgray)] pt-5">
          The goal of an AI-Powered Resume Scanner for job recruiters is to
      ...
      <div className="border rounded-2xl p-8 border-[var(--deepgreen)] mt-10 space-y-5 bg-[var(--light-gray)]">
        ...
        <p className="md:text-xl text-[var(--darkgray)] border-b pb-5">
          {" "}
          The goal of an Al-Powered Resume Scanner for job recruiters is to
          expedite and optimize the candidate selection process by leveraging
          artificial intelligence algorithms to quickly and accurately assess
          resumes.
        </p>
        ...
        <div className="pt-3 md:flex items-center gap-20 space-y-4 md:space-y-0">
          <div className="space-y-2">
            ...
            <p className="md:text-xl text-[var(--darkgray)]">2023</p>
          </div>
          <div className="space-y-2">
            <h1 className="font-bold md:text-xl">Type</h1>
            <p className="md:text-xl text-[var(--darkgray)]">Ai</p>
          </div>
          <div className="space-y-2">
            <h1 className="font-bold md:text-xl">Client</h1>
            <p className="md:text-xl text-[var(--darkgray)]">DocuMint.ai</p>
          </div>
        </div>
      </div>
      <div className="pt-10 cursor-pointer ">
        <Link href={"  https://docs-two-liart.vercel.app/"}>
